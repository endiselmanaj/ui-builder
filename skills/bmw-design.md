...
BMW corporate design system — light canvas, BMW Blue (#1c69d4) CTAs, rectangular buttons, BMW Type Next Latin at 700/300 weight contrast.
...
Never use inline SVG placeholders, colored rectangles, or emoji as image stand-ins. Always use real photographs from the internet via `<img src="...">` with full URLs. Prefer Unsplash for high-quality automotive and lifestyle photography.

**Recommended image sources (use these exact URLs):**

| Use case | Example URL |
|---|---|
| BMW sedan / M5 | `https://images.unsplash.com/photo-1555215695-3004980ad54e?w=800&q=80` |
| BMW coupe / M4 dark | `https://images.unsplash.com/photo-1556189250-72ba954cfc2b?w=800&q=80` |
| BMW sport / M2 CS blue | `https://images.unsplash.com/photo-1619362280286-f1f8fd5032ed?w=800&q=80` |
| BMW M3 in forest | `https://images.unsplash.com/photo-1607853554439-0069ec0f29b6?w=800&q=80` |
| BMW M4 blue / city | `https://images.unsplash.com/flagged/photo-1553505192-acca7d4509be?w=800&q=80` |
| BMW M4 red | `https://images.unsplash.com/photo-1617531653332-bd46c24f2068?w=800&q=80` |
| BMW 2 Series white | `https://images.unsplash.com/photo-1600268330186-76564be81357?w=800&q=80` |
| Dark hero / sunset | `https://images.unsplash.com/photo-1583692717320-0c9661d49d9a?w=1600&q=80` |
| Interior / dashboard | `https://images.unsplash.com/photo-1756195343297-3311a8289044?w=800&q=80` |
| BMW badge / logo | `https://images.unsplash.com/flagged/photo-1552305360-7a7c883f067c?w=400&q=80` |

**Rules:**
- Hero bands: use a full-bleed car photo as a background or a large inline image — never a grey placeholder box.
- Model cards: each card must show a real car photo — search Unsplash for "BMW [model name]" or use the URLs above.
- Always set `alt` text describing the vehicle (e.g., `alt="BMW iX3 electric SUV"`).
- Use `object-fit: cover` on card images to maintain aspect ratios without distortion.
- If you need additional car images, construct Unsplash URLs with `https://images.unsplash.com/photo-{id}?w={width}&q=80` or use `https://source.unsplash.com/random/800x600/?bmw,car` as a fallback.
...
### Do
- Use real car photographs from Unsplash (full URLs) for every hero, card, and feature image — never SVG placeholders or colored boxes.
...
### Don't
- Don't use inline SVGs, placeholder rectangles, or emoji as image substitutes — always use real photos via `<img>` with Unsplash URLs.
